    ...
    with data_path.open("r", encoding="utf-8") as f:
        for line in f:
            ...
            if day is None:
                ...
                sample_dates = sorted([d for d in series.keys() if d != None and datetime.strptime(d,"%Y-%m-%d") < datetime.strptime(date,"%Y-%m-%d")], reverse=True)[:5]
                return {
            ...
            if date == get_config_value("TODAY_DATE").split(' ')[0]:
                ...
                return {
                    ...
                    "ohlcv": {
                        ...
                        "MA_5":day.get("A1. MA_5"),
                        "MA_10":day.get("A2. MA_10"),
                        "MA_20":day.get("A3. MA_20"),
                        "MA_60":day.get("A4. MA_60"),
                        "EMA_5":day.get("B1. EMA_5"),
                        "EMA_10":day.get("B2. EMA_10"),
                        "EMA_20":day.get("B3. EMA_20"),
                        "EMA_60":day.get("B4. EMA_60"),
                        "RSI":day.get("C1. RSI"),
                        "DIF":day.get("C2. DIF"),
                        "DEA":day.get("C3. DEA"),
                        "ATR":day.get("C4. ATR"),
