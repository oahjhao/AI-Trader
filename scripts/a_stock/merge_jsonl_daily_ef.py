...
if __name__ == "__main__":
    ...
    parser.add_argument('--csv-path', type=str, default='A_stock_daily.csv', help='CSV文件名')
    parser.add_argument('--output-path', type=str, default='merged.jsonl', help='输出JSONL文件名')
